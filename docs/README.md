...
2. if `report_id` passed, rule will be assigned this report (will overwrite any existing value)
3. if ID passed in rule or via CLI, the following logic will apply...
