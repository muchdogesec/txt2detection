...
- `"tags"`: **Generated by AI**, including:  
  - ATT&CK Technique IDs and ATT&CK Sub-technique IDs in the format `attack.ID` (e.g. `attack.T1595`) and CVE IDs in the format `cve.ID` (e.g. `cve.2024-56520`) relevant to the report.
